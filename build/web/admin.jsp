<%-- 
    Document   : profile
    Created on : Nov 12, 2021, 12:40:33 AM
    Author     : Hi
--%>
                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                      ...
                      <li> <a href="ticketmanager.jsp">TicketManager</a> </li>
                      <li> <a href="usermanager.jsp">UserManager </a> </li>
    ...
    <div class="row">
        ...
        <div class="col-md-9 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Full Name</label><h3>${sessionScope.acc.firstname} ${sessionScope.acc.lastname}</h3></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Mobile Number</label><h3>${sessionScope.acc.phonenumber}</h3></div>
                     <div class="col-md-12"><label class="labels">Number of Ticket Bought</label><h3>${sessionScope.acc.nOt}</h3></div>
                   
                </div>
                </div>
                <div class="row mt-4">
                <div class="col-md-6"><a href="editprofile" class="btn btn-primary profile-button" >Edit Profile</a></div>
