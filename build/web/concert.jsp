<%-- 
    Document   : concert
    Created on : Nov 4, 2021, 11:12:06 PM
    Author     : Hi
--%>
                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                      ...
                      <li class="active"> <a href="./concert">Concerts </a> </li>
    ...
    <div class="row display_boxflex">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
       <div class="box_text">
          ...
          <h1> Giá vé: ${o.cprice} đồng </h1>
          <h3> Số vé: ${o.nOt} vé </h3>
          <h3> Địa điểm: ${o.clocation} </h3>
          <h3> Thời gian: ${o.cdate}</h3>
          <c:if test="${sessionScope.acc !=null}">
          <a href="cart?pid=${o.cid}" id="button" class="buttonbuy">Buy now</a>
            </c:if>
        </div>
      </div> 
              
      <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 border_right">
         <div class="upcomimg">
           <figure><img src="${o.img}"/></figure>
