<%-- 
    Document   : login
    Created on : Nov 5, 2021, 2:29:24 AM
    Author     : Hi
--%>
                      ...
                      <li class="action-profile">
                        ...
                        <div class="menu-profile">
                          ...
                          <ul>
                            ...
                            <li><img src="images/edit.png"><a href="profile.jsp">Edit profile</a></li>
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-md-12" >
              ...
              <div class="col-md-12">
                <input class="loginuser" placeholder="Email" type="text" name="user">
              </div>
              <div class="col-md-12">
              ...
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" >
                ...
                <a href="Signup.jsp" class="buttonlogin">Sign up</a>
