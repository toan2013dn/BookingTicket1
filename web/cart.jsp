<%-- 
    Document   : cart
    Created on : Nov 12, 2021, 12:42:28 AM
    Author     : Hi
--%>
      ...
      <div class="products">
        ...
        <div class="product">
          ...
          <div class="product-info">
            ...
            <h3 class="product-name">${detail.cname}</h3>
  
            <h4 class="product-price">${detail.cprice}đ</h4>
  
            <p class="product-quantity">Số lượng: <input type="text" name="qtt">  
            <p class="product-remove">
  
              <i class="fa fa-trash" aria-hidden="true"></i>
  
              <a href="checkout?cid=${detail.cid}"> <span class="remove">Proceed To Payment</span></a>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-12 border_top">
              <form class="news">
               <h3>E-mail</h3>
               <input class="newslatter" placeholder="ENTER YOUR MAIL">
                    ...
                    <ul class="loca">
                      <li>
                        ...
                        <li>
                            ...
                            <a href="#"><img src="icon/call.png" alt="#" /></a>+ <input type="text" name="not" value="${detail.nOt}" readonly required> </li>
                          <li>
