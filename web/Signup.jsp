<%-- 
    Document   : Signup
    Created on : Nov 5, 2021, 3:02:51 AM
    Author     : Hi
--%>
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="col-md-12">
                <input class="signuser" placeholder="E-mail" type="text" name="email">
              </div>
                <div class="col-md-12">
                <input class="signuser" placeholder="First Name" type="text" name="firstname">
              </div>
              <div class="col-md-12">
                <input class="signuser" placeholder="Last Name" type="text" name="lastname">
              </div>
                 <div class="col-md-12">
                <input class="signuser" placeholder="Phone Number" type="Text" name="phoneno">
              </div>
              <div class="col-md-12">
                <input class="signuser" placeholder="Password" type="password" name="psw">
              </div>
              <div class="col-md-12">
                <input class="signuser" placeholder="Repeat your password" type="password" name="re_psw">
              </div>
